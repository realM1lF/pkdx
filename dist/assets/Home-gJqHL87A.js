...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:tr,depthTest:!1,depthWrite:!1})}function AM(r,e,t){const n=new Float32Array($r),i=new q(0,1,0);return new bi({name:"SphericalGaussianBlur",defines:{n:$r,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Fl(),fragmentShader:`
		...
		`,blending:tr,depthTest:!1,depthWrite:!1})}function md(){return new bi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fl(),fragmentShader:`
		...
		`,blending:tr,depthTest:!1,depthWrite:!1})}function gd(){return new bi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fl(),fragmentShader:`
	...
	`}class Xm extends zi{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},i=[n,n,n,n,n,n];this.texture=new km(i),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new cr(l,c),d=new zf(-1,1,1,-1,0,1);let f=null,h=null,g=!1,_,p=null,m=[],b=!1;this.setSize=function(w,S){a.setSize(w,S),o.setSize(w,S);for(let E=0;E<m.length;E++){const T=m[E];T.setSize&&T.setSize(w,S)}},this.setEffects=function(w){m=w,b=m.length>0&&m[0].isRenderPass===!0;const S=a.width,E=a.height;for(let T=0;T<m.length;T++){const A=m[T];A.setSize&&A.setSize(S,E)}},this.begin=function(w,S){if(g||w.toneMapping===ki&&m.length===0)return!1;if(p=S,S!==null){const E=S.width,T=S.height;(a.width!==E||a.height!==T)&&this.setSize(E,T)}return b===!1&&w.setRenderTarget(a),_=w.toneMapping,w.toneMapping=ki,!0},this.hasRenderPass=function(){return b},this.end=function(w,S){w.toneMapping=_,g=!0;let E=a,T=o;for(let A=0;A<m.length;A++){const v=m[A];if(v.enabled!==!1&&(v.render(w,T,E,S),v.needsSwap!==!1)){const y=E;E=T,T=y}}if(f!==w.outputColorSpace||h!==w.toneMapping){f=w.outputColorSpace,h=w.toneMapping,c.defines={},ot.getTransfer(f)===xt&&(c.defines.SRGB_TRANSFER="");const A=IM[h];A&&(c.defines[A]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=E.texture,w.setRenderTarget(p),w.render(u,d),p=null,g=!1},this.isCompositing=function(){return g},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),l.dispose(),c.dispose()}}const Ym=new Nn,ju=new la(1,1),qm=new Dm,$m=new rx,Km=new km,_d=[],xd=[],vd=new Float32Array(16),Sd=new Float32Array(9),Md=new Float32Array(4);function fa(r,e,t){const n=r[0];if(n<=0||n>0)return r;const i=e*t;let s=_d[i];if(s===void 0&&(s=new Float32Array(i),_d[i]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,r[a].toArray(s,o)}return s}function tn(r,e){if(r.length!==e.length)return!1;for(let t=0,n=r.length;t<n;t++)if(r[t]!==e[t])return!1;return!0}function nn(r,e){for(let t=0,n=e.length;t<n;t++)r[t]=e[t]}function Ol(r,e){let t=xd[e];t===void 0&&(t=new Int32Array(e),xd[e]=t);for(let n=0;n!==e;++n)t[n]=r.allocateTextureUnit();return t}function FM(r,e){const t=this.cache;t[0]!==e&&(r.uniform1f(this.addr,e),t[0]=e)}function OM(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(tn(t,e))return;r.uniform2fv(this.addr,e),nn(t,e)}}function BM(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(tn(t,e))return;r.uniform3fv(this.addr,e),nn(t,e)}}function kM(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(tn(t,e))return;r.uniform4fv(this.addr,e),nn(t,e)}}function zM(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(tn(t,e))return;r.uniformMatrix2fv(this.addr,!1,e),nn(t,e)}else{if(tn(t,n))return;Md.set(n),r.uniformMatrix2fv(this.addr,!1,Md),nn(t,n)}}function GM(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(tn(t,e))return;r.uniformMatrix3fv(this.addr,!1,e),nn(t,e)}else{if(tn(t,n))return;Sd.set(n),r.uniformMatrix3fv(this.addr,!1,Sd),nn(t,n)}}function HM(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(tn(t,e))return;r.uniformMatrix4fv(this.addr,!1,e),nn(t,e)}else{if(tn(t,n))return;vd.set(n),r.uniformMatrix4fv(this.addr,!1,vd),nn(t,n)}}function VM(r,e){const t=this.cache;t[0]!==e&&(r.uniform1i(this.addr,e),t[0]=e)}function WM(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(tn(t,e))return;r.uniform2iv(this.addr,e),nn(t,e)}}function XM(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(tn(t,e))return;r.uniform3iv(this.addr,e),nn(t,e)}}function YM(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(tn(t,e))return;r.uniform4iv(this.addr,e),nn(t,e)}}function qM(r,e){const t=this.cache;t[0]!==e&&(r.uniform1ui(this.addr,e),t[0]=e)}function $M(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(tn(t,e))return;r.uniform2uiv(this.addr,e),nn(t,e)}}function KM(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(tn(t,e))return;r.uniform3uiv(this.addr,e),nn(t,e)}}function ZM(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(tn(t,e))return;r.uniform4uiv(this.addr,e),nn(t,e)}}function jM(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);let s;this.type===r.SAMPLER_2D_SHADOW?(ju.compareFunction=t.isReversedDepthBuffer()?Bf:Of,s=ju):s=Ym,t.setTexture2D(e||s,i)}function JM(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||$m,i)}function QM(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Km,i)}function ey(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||qm,i)}function ty(r){switch(r){case 5126:return FM;case 35664:return OM;case 35665:return BM;case 35666:return kM;case 35674:return zM;case 35675:return GM;case 35676:return HM;case 5124:case 35670:return VM;case 35667:case 35671:return WM;case 35668:case 35672:return XM;case 35669:case 35673:return YM;case 5125:return qM;case 36294:return $M;case 36295:return KM;case 36296:return ZM;case 35678:case 36198:case 36298:case 36306:case 35682:return jM;case 35679:case 36299:case 36307:return JM;case 35680:case 36300:case 36308:case 36293:return QM;case 36289:case 36303:case 36311:case 36292:return ey}}function ny(r,e){r.uniform1fv(this.addr,e)}function iy(r,e){const t=fa(e,this.size,2);r.uniform2fv(this.addr,t)}function ry(r,e){const t=fa(e,this.size,3);r.uniform3fv(this.addr,t)}function sy(r,e){const t=fa(e,this.size,4);r.uniform4fv(this.addr,t)}function ay(r,e){const t=fa(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,t)}function oy(r,e){const t=fa(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,t)}function ly(r,e){const t=fa(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,t)}function cy(r,e){r.uniform1iv(this.addr,e)}function uy(r,e){r.uniform2iv(this.addr,e)}function fy(r,e){r.uniform3iv(this.addr,e)}function hy(r,e){r.uniform4iv(this.addr,e)}function dy(r,e){r.uniform1uiv(this.addr,e)}function py(r,e){r.uniform2uiv(this.addr,e)}function my(r,e){r.uniform3uiv(this.addr,e)}function gy(r,e){r.uniform4uiv(this.addr,e)}function _y(r,e,t){const n=this.cache,i=e.length,s=Ol(t,i);tn(n,s)||(r.uniform1iv(this.addr,s),nn(n,s));let a;this.type===r.SAMPLER_2D_SHADOW?a=ju:a=Ym;for(let o=0;o!==i;++o)t.setTexture2D(e[o]||a,s[o])}function xy(r,e,t){const n=this.cache,i=e.length,s=Ol(t,i);tn(n,s)||(r.uniform1iv(this.addr,s),nn(n,s));for(let a=0;a!==i;++a)t.setTexture3D(e[a]||$m,s[a])}function vy(r,e,t){const n=this.cache,i=e.length,s=Ol(t,i);tn(n,s)||(r.uniform1iv(this.addr,s),nn(n,s));for(let a=0;a!==i;++a)t.setTextureCube(e[a]||Km,s[a])}function Sy(r,e,t){const n=this.cache,i=e.length,s=Ol(t,i);tn(n,s)||(r.uniform1iv(this.addr,s),nn(n,s));for(let a=0;a!==i;++a)t.setTexture2DArray(e[a]||qm,s[a])}function My(r){switch(r){case 5126:return ny;case 35664:return iy;case 35665:return ry;case 35666:return sy;case 35674:return ay;case 35675:return oy;case 35676:return ly;case 5124:case 35670:return cy;case 35667:case 35671:return uy;case 35668:case 35672:return fy;case 35669:case 35673:return hy;case 5125:return dy;case 36294:return py;case 36295:return my;case 36296:return gy;case 35678:case 36198:case 36298:case 36306:case 35682:return _y;case 35679:case 36299:case 36307:return xy;case 35680:case 36300:case 36308:case 36293:return vy;case 36289:case 36303:case 36311:case 36292:return Sy}}class yy{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=ty(t.type)}}class by{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=My(t.type)}}class Ey{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let s=0,a=i.length;s!==a;++s){const o=i[s];o.setValue(e,t[o.id],n)}}}const Dc=/(\w+)(\])?(\[|\.)?/g;function yd(r,e){r.seq.push(e),r.map[e.id]=e}function Ty(r,e,t){const n=r.name,i=n.length;for(Dc.lastIndex=0;;){const s=Dc.exec(n),a=Dc.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){yd(t,c===void 0?new yy(o,r,e):new by(o,r,e));break}else{let d=t.map[o];d===void 0&&(d=new Ey(o),yd(t,d)),t=d}}}class cl{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);Ty(o,l,this)}const i=[],s=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?i.push(a):s.push(a);i.length>0&&(this.seq=i.concat(s))}setValue(e,t,n,i){const s=this.map[t];s!==void 0&&s.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,s=e.length;i!==s;++i){const a=e[i];a.id in t&&n.push(a)}return n}}function bd(r,e,t){const n=r.createShader(e);return r.shaderSource(n,t),r.compileShader(n),n}const Ay=37297;let wy=0;function Ry(r,e){const t=r.split(`
`),n=[],i=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=i;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Ed=new $e;function Cy(r){ot._getMatrix(Ed,ot.workingColorSpace,r);const e=`mat3( ${Ed.elements.map(t=>t.toFixed(4))} )`;switch(ot.getTransfer(r)){case El:return[e,"LinearTransferOETF"];case xt:return[e,"sRGBTransferOETF"];default:return He("WebGLProgram: Unsupported color space: ",r),[e,"LinearTransferOETF"]}}function Td(r,e,t){const n=r.getShaderParameter(e,r.COMPILE_STATUS),s=(r.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+s+`

`+Ry(r.getShaderSource(e),o)}else return s}function Py(r,e){const t=Cy(e);return[`vec4 ${r}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const Dy={[mm]:"Linear",[gm]:"Reinhard",[_m]:"Cineon",[xm]:"ACESFilmic",[Sm]:"AgX",[Mm]:"Neutral",[vm]:"Custom"};function Ny(r,e){const t=Dy[e];return t===void 0?(He("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const qo=new q;function Ly(){ot.getLuminanceCoefficients(qo);const r=qo.x.toFixed(4),e=qo.y.toFixed(4),t=qo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Iy(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Pa).join(`
`)}function Uy(r){const e=[];for(const t in r){const n=r[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Fy(r,e){const t={},n=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(e,i),a=s.name;let o=1;s.type===r.FLOAT_MAT2&&(o=2),s.type===r.FLOAT_MAT3&&(o=3),s.type===r.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:r.getAttribLocation(e,a),locationSize:o}}return t}function Pa(r){return r!==""}function Ad(r,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function wd(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Oy=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ju(r){return r.replace(Oy,ky)}const By=new Map;function ky(r,e){let t=je[e];if(t===void 0){const n=By.get(e);if(n!==void 0)t=je[n],He('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return Ju(t)}const zy=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Rd(r){return r.replace(zy,Gy)}function Gy(r,e,t,n){let i="";for(let s=parseInt(e);s<parseInt(t);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function Cd(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}const Hy={[rl]:"SHADOWMAP_TYPE_PCF",[Ca]:"SHADOWMAP_TYPE_VSM"};function Vy(r){return Hy[r.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Wy={[fs]:"ENVMAP_TYPE_CUBE",[oa]:"ENVMAP_TYPE_CUBE",[Ll]:"ENVMAP_TYPE_CUBE_UV"};function Xy(r){return r.envMap===!1?"ENVMAP_TYPE_CUBE":Wy[r.envMapMode]||"ENVMAP_TYPE_CUBE"}const Yy={[oa]:"ENVMAP_MODE_REFRACTION"};function qy(r){return r.envMap===!1?"ENVMAP_MODE_REFLECTION":Yy[r.envMapMode]||"ENVMAP_MODE_REFLECTION"}const $y={[pm]:"ENVMAP_BLENDING_MULTIPLY",[O0]:"ENVMAP_BLENDING_MIX",[B0]:"ENVMAP_BLENDING_ADD"};function Ky(r){return r.envMap===!1?"ENVMAP_BLENDING_NONE":$y[r.combine]||"ENVMAP_BLENDING_NONE"}function Zy(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function jy(r,e,t,n){const i=r.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Vy(t),c=Xy(t),u=qy(t),d=Ky(t),f=Zy(t),h=Iy(t),g=Uy(s),_=i.createProgram();let p,m,b=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+m);const w=b+p+a,S=b+m+o,E=bd(i,i.VERTEX_SHADER,w),T=bd(i,i.FRAGMENT_SHADER,S);i.attachShader(_,E),i.attachShader(_,T),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.hasPositionAttribute===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(L){if(r.debug.checkShaderErrors){const D=i.getProgramInfoLog(_)||"",O=i.getShaderInfoLog(E)||"",G=i.getShaderInfoLog(T)||"",U=D.trim(),H=O.trim(),B=G.trim();let K=!0,te=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(K=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,E,T);else{const N=Td(i,E,"vertex"),ae=Td(i,T,"fragment");ht("WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
`;function Ib({className:r}){const e=Ke.useRef(null);return Ke.useEffect(()=>{const t=e.current;if(!t)return;const n=t.parentElement;if(!n)return;const i=window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=window.matchMedia("(pointer: coarse)").matches?117:350,o=new Cb({canvas:t,alpha:!0,antialias:!1});o.setClearColor(0,0);const l=new hx,c=new zf(-1,1,1,-1,-10,10),u=new Ei,d=new Float32Array(a*3),f=new Float32Array(a),h=new Float32Array(a*4),g=[];let _=n.clientWidth,p=n.clientHeight;for(let O=0;O<a;O++){let G=Pb,U=.3;Math.random()>.6&&(G=Db[Math.floor(Math.random()*3)],U=.5),h[O*4]=G.r,h[O*4+1]=G.g,h[O*4+2]=G.b,h[O*4+3]=U,f[O]=1+Math.random()*2,g.push({bx:(Math.random()-.5)*_,by:(Math.random()-.5)*p,vy:2+Math.random()*4,phase:Math.random()*Math.PI*2,swayAmp:4+Math.random()*8,dx:0,dy:0})}u.setAttribute("position",new ni(d,3)),u.setAttribute("aSize",new ni(f,1)),u.setAttribute("aColor",new ni(h,4));const m=new bi({vertexShader:Nb,fragmentShader:Lb,transparent:!0,depthWrite:!1,blending:ou,uniforms:{uPixelRatio:{value:Math.min(window.devicePixelRatio,2)}}}),b=new bx(u,m);l.add(b);const w=()=>{_=n.clientWidth,p=n.clientHeight,o.setSize(_,p,!1),o.setPixelRatio(Math.min(window.devicePixelRatio,2)),c.left=-_/2,c.right=_/2,c.top=p/2,c.bottom=-p/2,c.updateProjectionMatrix()};w();const S={x:-9999,y:-9999},E=O=>{const G=t.getBoundingClientRect();S.x=O.clientX-G.left-_/2,S.y=-(O.clientY-G.top-p/2)},T=()=>{S.x=-9999,S.y=-9999};n.addEventListener("pointermove",E,{passive:!0}),n.addEventListener("pointerleave",T,{passive:!0});const A=new ResizeObserver(w);A.observe(n);let v=0,y=!0;const C=120,L=O=>{if(v=requestAnimationFrame(L),!y)return;const G=O/1e3;for(let U=0;U<a;U++){const H=g[U],B=H.bx+Math.sin(G*.4+H.phase)*H.swayAmp+H.dx,te=((H.by+G*H.vy+p/2)%(p+40)+p+40)%(p+40)-p/2-20+H.dy,N=B-S.x,ae=te-S.y,de=Math.hypot(N,ae);if(de<C&&de>.01){const Ve=(C-de)/C*1.6;H.dx+=N/de*Ve,H.dy+=ae/de*Ve}H.dx*=.95,H.dy*=.95,d[U*3]=B,d[U*3+1]=te,d[U*3+2]=0}u.attributes.position.needsUpdate=!0,o.render(l,c)},D=new IntersectionObserver(([O])=>{y=O.isIntersecting});if(D.observe(n),i){for(let O=0;O<a;O++)d[O*3]=g[O].bx,d[O*3+1]=g[O].by,d[O*3+2]=0;u.attributes.position.needsUpdate=!0,o.render(l,c)}else v=requestAnimationFrame(L);return()=>{cancelAnimationFrame(v),D.disconnect(),A.disconnect(),n.removeEventListener("pointermove",E),n.removeEventListener("pointerleave",T),u.dispose(),m.dispose(),o.dispose()}},[]),P.jsx("canvas",{"code-path":"src/pages/home/ParticleField.tsx:199:5",ref:e,className:r,style:{position:"absolute",inset:0,width:"100%",height:"100%",zIndex:1,pointerEvents:"none"},"aria-hidden":!0})}const Ub=Ke.memo(Ib),Va=[.16,1,.3,1],Id=[{id:6,name:"Charizard",type:"fire",artOffsetX:-18},{id:3,name:"Venusaur",type:"grass",artOffsetX:-10},{id:9,name:"Blastoise",type:"water",artOffsetX:-12}],jm=[{id:1,name:"Bulbasaur"},{id:4,name:"Charmander"},{id:7,name:"Squirtle"}];function Ud({text:r,started:e,baseDelay:t=0,gradient:n=!1}){return P.jsx("span",{"code-path":"src/pages/home/Hero.tsx:44:5","aria-label":r,className:"inline-block",children:Array.from(r).map((i,s)=>P.jsx("span",{"code-path":"src/pages/home/Hero.tsx:46:9","aria-hidden":!0,className:"inline-block overflow-hidden align-bottom",children:P.jsx(it.span,{"code-path":"src/pages/home/Hero.tsx:47:11",className:Oi("inline-block will-change-transform",n&&"text-gradient-alive"),initial:{y:60,rotate:6,opacity:0},animate:e?{y:0,rotate:0,opacity:1}:{},transition:{duration:.7,delay:t+s*.022,ease:Va},children:i===" "?" ":i})},s))})}function Fb({started:r}){const{t:e}=Vn(),t=ps(),[n,i]=Ke.useState(0);Ke.useEffect(()=>{if(!r||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const o=window.setInterval(()=>i(l=>(l+1)%Id.length),6e3);return()=>window.clearInterval(o)},[r]);const s=Id[n],a=Lt[s.type].rgb;return P.jsxs(it.div,{"code-path":"src/pages/home/Hero.tsx:77:5",className:"relative mx-auto h-[300px] w-[300px] lg:h-[520px] lg:w-[520px]",initial:{scale:.8,opacity:0},animate:r?{scale:1,opacity:1}:{},transition:{type:"spring",stiffness:180,damping:22,delay:.5},children:[P.jsxs("div",{"code-path":"src/pages/home/Hero.tsx:84:7",className:"absolute inset-0 z-0",children:[P.jsx(rr,{"code-path":"src/pages/home/Hero.tsx:85:9",mode:"sync",children:P.jsx(it.div,{"code-path":"src/pages/home/Hero.tsx:86:11",className:"type-aura animate-breathe",style:{background:`radial-gradient(circle at 50% 55%, rgba(${a},0.38) 0%, rgba(${a},0.12) 42%, transparent 70%)`},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.6}},s.type)}),P.jsx("div",{"code-path":"src/pages/home/Hero.tsx:99:9",className:"absolute bottom-[8%] left-1/2 w-[58%] -translate-x-1/2",children:P.jsx("div",{"code-path":"src/pages/home/Hero.tsx:100:11",className:"h-6 w-full animate-breathe rounded-[50%] border border-gold/50",style:{boxShadow:"0 0 24px rgba(246,201,69,0.25), inset 0 0 18px rgba(246,201,69,0.12)"}})})]}),P.jsx("div",{"code-path":"src/pages/home/Hero.tsx:108:7",className:"absolute inset-x-0 bottom-[9%] z-10 mx-auto h-[84%] w-[84%] lg:h-[88%] lg:w-[88%]",style:{transform:`translateX(${s.artOffsetX}px)`},children:P.jsx(rr,{"code-path":"src/pages/home/Hero.tsx:112:9",mode:"sync",children:P.jsx(it.img,{"code-path":"src/pages/home/Hero.tsx:113:11",src:Sr.artwork(s.id),alt:e("home.hero.artworkAlt",{name:os(s.id,t)}),draggable:!1,className:"absolute inset-0 h-full w-full object-contain object-bottom drop-shadow-[0_24px_48px_rgba(0,0,0,0.5)]",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.6,ease:Va}},s.id)})}),P.jsx("div",{"code-path":"src/pages/home/Hero.tsx:128:7",className:"absolute inset-0 z-20 hidden animate-spin-slow lg:block","aria-hidden":!0,children:jm.map((o,l)=>P.jsx("div",{"code-path":"src/pages/home/Hero.tsx:130:11",className:"absolute left-1/2 top-1/2",style:{transform:`rotate(${l*120}deg) translateX(212px)`},children:P.jsx("div",{"code-path":"src/pages/home/Hero.tsx:135:13",className:"animate-spin-rev",children:P.jsx("div",{"code-path":"src/pages/home/Hero.tsx:136:15",style:{transform:`rotate(${-l*120}deg)`},children:P.jsx(it.div,{"code-path":"src/pages/home/Hero.tsx:137:17",initial:{scale:0},animate:r?{scale:1}:{},transition:{type:"spring",stiffness:420,damping:30,delay:.9+l*.12},children:P.jsx(no,{"code-path":"src/pages/home/Hero.tsx:142:19",id:o.id,name:os(o.id,t),era:"gen5",skeleton:!1,className:"-ml-12 -mt-12 h-24 w-24"})})})})},o.id))})]})}function Ob({started:r}){const e=kd(),t=zd(),n=dg(pg()??""),{t:i}=Vn(),s=ps(),a=Ke.useRef(null),[o,l]=Ke.useState(!1),{scrollYProgress:c}=Qm({target:a,offset:["start start","end start"]}),u=Gd(c,[0,.6],[0,48]),d=()=>{if(o)return;l(!0);const f=1+Math.floor(Math.random()*Hd);window.setTimeout(()=>e(t(`/pokemon/${f}`)),500)};return P.jsxs("section",{"code-path":"src/pages/home/Hero.tsx:178:5",ref:a,className:"relative -mt-16 flex min-h-[100svh] items-center overflow-hidden",children:[P.jsx(m0,{"code-path":"src/pages/home/Hero.tsx:179:7"}),P.jsx(Ub,{"code-path":"src/pages/home/Hero.tsx:180:7"}),P.jsxs(it.div,{"code-path":"src/pages/home/Hero.tsx:182:7",style:{y:u},className:"relative z-10 mx-auto grid w-full max-w-content gap-10 px-4 pb-24 pt-28 md:px-8 lg:grid-cols-12 lg:items-center lg:gap-6 lg:pb-16",children:[P.jsxs("div",{"code-path":"src/pages/home/Hero.tsx:187:9",className:"lg:col-span-7",children:[P.jsx(it.p,{"code-path":"src/pages/home/Hero.tsx:188:11",className:"pixel-label text-[11px] text-gold",initial:{opacity:0,letterSpacing:"0.3em"},animate:r?{opacity:1,letterSpacing:"0.08em"}:{},transition:{duration:.4},children:i("home.hero.eyebrow")}),P.jsxs("h1",{"code-path":"src/pages/home/Hero.tsx:197:11",className:"mt-6 font-display text-[clamp(48px,8vw,96px)] font-black uppercase leading-[1.02] tracking-[0.01em]",children:[P.jsx(Ud,{"code-path":"src/pages/home/Hero.tsx:198:13",text:i("home.hero.titleA"),started:r,baseDelay:.15}),P.jsx("br",{"code-path":"src/pages/home/Hero.tsx:199:13"}),P.jsx(Ud,{"code-path":"src/pages/home/Hero.tsx:200:13",text:i("home.hero.titleB"),started:r,baseDelay:.45})]}),P.jsx(it.p,{"code-path":"src/pages/home/Hero.tsx:203:11",className:"mt-6 max-w-[56ch] font-sans text-lg leading-[1.6] text-tx-secondary",initial:{y:24,opacity:0},animate:r?{y:0,opacity:1}:{},transition:{duration:.5,delay:.7,ease:Va},children:i("home.hero.blurb")}),P.jsxs(it.div,{"code-path":"src/pages/home/Hero.tsx:212:11",className:"mt-8 flex flex-wrap items-center gap-4",initial:{y:24,opacity:0},animate:r?{y:0,opacity:1}:{},transition:{duration:.5,delay:.79,ease:Va},children:[P.jsxs(as,{"code-path":"src/pages/home/Hero.tsx:218:13",to:"/pokedex",className:"group relative inline-flex items-center gap-2 overflow-hidden rounded-md border border-gold/60 bg-[linear-gradient(135deg,rgba(246,201,69,0.25),rgba(246,201,69,0.10))] px-7 py-3.5 font-display text-sm font-bold uppercase tracking-[0.06em] text-tx-primary transition-all duration-200 hover:-translate-y-0.5 hover:border-gold hover:shadow-glow-gold active:scale-[0.97]",children:[P.jsx("span",{"code-path":"src/pages/home/Hero.tsx:222:15",className:"absolute inset-0 -translate-x-full bg-[linear-gradient(110deg,transparent_30%,rgba(255,255,255,0.35)_50%,transparent_70%)] transition-transform duration-sheen group-hover:translate-x-full"}),P.jsx("span",{"code-path":"src/pages/home/Hero.tsx:223:15",className:"relative",children:i("home.hero.cta")})]}),P.jsxs("button",{"code-path":"src/pages/home/Hero.tsx:225:13",type:"button",onClick:d,className:"inline-flex items-center gap-2 rounded-md border border-hairline2 px-7 py-3.5 font-display text-sm font-bold uppercase tracking-[0.06em] text-tx-secondary transition-all duration-200 hover:-translate-y-0.5 hover:bg-surface3 hover:text-gold active:scale-[0.97]",children:[P.jsx(it.span,{"code-path":"src/pages/home/Hero.tsx:230:15",animate:o?{rotate:360}:{rotate:0},transition:{duration:.5,ease:"easeInOut"},className:"inline-flex",children:P.jsx(Eg,{"code-path":"src/pages/home/Hero.tsx:235:17",size:18,strokeWidth:1.75})}),i("home.hero.surprise")]}),n&&P.jsxs(as,{"code-path":"src/pages/home/Hero.tsx:240:15",to:`/nuzlocke/${n.run.id}`,className:"inline-flex flex-col rounded-md border border-hairline2 px-5 py-3 text-left transition-colors hover:border-gold/50 hover:text-gold",children:[P.jsx("span",{"code-path":"src/pages/home/Hero.tsx:244:17",className:"font-display text-[11px] font-bold uppercase tracking-[0.06em] text-tx-primary",children:i("nuz.continueRun")}),P.jsx("span",{"code-path":"src/pages/home/Hero.tsx:245:17",className:"mt-0.5 text-[11px] text-tx-muted",children:i("nuz.continueRunHint",{name:n.run.name})})]})]}),P.jsx(it.p,{"code-path":"src/pages/home/Hero.tsx:250:11",className:"pixel-label mt-8 text-[9px] text-tx-muted",initial:{y:24,opacity:0},animate:r?{y:0,opacity:1}:{},transition:{duration:.5,delay:.88,ease:Va},children:i("home.hero.stats")})]}),P.jsxs("div",{"code-path":"src/pages/home/Hero.tsx:261:9",className:"overflow-visible lg:col-span-5",children:[P.jsx(Fb,{"code-path":"src/pages/home/Hero.tsx:262:11",started:r}),P.jsx(it.div,{"code-path":"src/pages/home/Hero.tsx:264:11",className:"mt-4 flex items-center justify-center gap-6 lg:hidden",initial:{opacity:0},animate:r?{opacity:1}:{},transition:{delay:1,duration:.5},children:jm.map(f=>P.jsx(no,{"code-path":"src/pages/home/Hero.tsx:271:15",id:f.id,name:os(f.id,s),era:"gen5",skeleton:!1,className:"h-16 w-16"},f.id))})]})]}),P.jsxs(it.a,{"code-path":"src/pages/home/Hero.tsx:278:7",href:"#search-gateway",className:"absolute bottom-6 left-1/2 z-10 flex -translate-x-1/2 flex-col items-center gap-1 text-tx-muted transition-colors hover:text-gold",initial:{opacity:0},animate:r?{opacity:1}:{},transition:{delay:1.3,duration:.5},"aria-label":i("home.hero.scrollAria"),children:[P.jsx("span",{"code-path":"src/pages/home/Hero.tsx:286:9",className:"pixel-label text-[9px]",children:i("home.hero.scroll")}),P.jsx(gg,{"code-path":"src/pages/home/Hero.tsx:287:9",size:20,strokeWidth:1.75,className:"animate-cue-bounce"})]})]})}function Gf({children:r,className:e,delay:t=0,y:n=40}){return P.jsx(it.div,{"code-path":"src/pages/home/Reveal.tsx:15:5",className:e,initial:{opacity:0,y:n,filter:"blur(8px)"},whileInView:{opacity:1,y:0,filter:"blur(0px)"},viewport:{once:!0,margin:"-20% 0px"},transition:{duration:.6,delay:t,ease:[.16,1,.3,1]},children:r})}const Bb=["fire","water","grass","electric","psychic","dragon","ghost","fairy"];function kb(){const{t:r}=Vn(),e=ps();return P.jsxs("section",{"code-path":"src/pages/home/SearchGateway.tsx:19:5",id:"search-gateway",className:"relative bg-abyss pt-24 pb-12",children:[P.jsx("div",{"code-path":"src/pages/home/SearchGateway.tsx:20:7",className:"absolute inset-x-0 top-0 h-px",style:{background:"linear-gradient(90deg, transparent, rgba(255,122,69,0.3), rgba(69,200,255,0.3), rgba(255,214,10,0.3), transparent)"}}),P.jsxs(Gf,{"code-path":"src/pages/home/SearchGateway.tsx:27:7",className:"mx-auto flex w-full max-w-[720px] flex-col items-center gap-6 px-4",children:[P.jsx("span",{"code-path":"src/pages/home/SearchGateway.tsx:28:9",className:"pixel-label text-[10px] text-gold",children:r("home.gateway.eyebrow")}),P.jsx("h2",{"code-path":"src/pages/home/SearchGateway.tsx:29:9",className:"text-center font-display text-[clamp(24px,3vw,36px)] font-extrabold uppercase leading-[1.15]",children:r("home.gateway.title")}),P.jsx(eg,{"code-path":"src/pages/home/SearchGateway.tsx:33:9",variant:"inline",className:"w-full"}),P.jsxs("div",{"code-path":"src/pages/home/SearchGateway.tsx:35:9",className:"flex flex-wrap items-center justify-center gap-2",children:[P.jsx("span",{"code-path":"src/pages/home/SearchGateway.tsx:36:11",className:"pixel-label mr-1 text-[9px] text-tx-muted",children:r("home.gateway.popular")}),Bb.map((t,n)=>P.jsx(it.div,{"code-path":"src/pages/home/SearchGateway.tsx:38:13",initial:{scale:.8,opacity:0},whileInView:{scale:1,opacity:1},viewport:{once:!0,margin:"-10% 0px"},transition:{type:"spring",stiffness:420,damping:30,delay:.15+n*.04},children:P.jsxs(as,{"code-path":"src/pages/home/SearchGateway.tsx:45:15",to:`/pokedex?type=${t}`,"data-type":t,className:"inline-flex items-center gap-1.5 rounded-pill border border-hairline bg-surface2 px-3 py-1.5 font-sans text-xs font-semibold capitalize text-tx-secondary transition-all duration-200 ease-out-expo hover:-translate-y-0.5 hover:border-[rgba(var(--t),0.8)] hover:bg-[rgba(var(--t),0.18)] hover:text-[rgb(var(--t))] hover:shadow-[0_0_16px_rgba(var(--t),0.35)]",style:{"--t":Lt[t].rgb},children:[P.jsx(Rl,{"code-path":"src/pages/home/SearchGateway.tsx:51:17",type:t,size:16}),ef(t,e)]})},t))]})]})]})}const zb=[.16,1,.3,1],Gb=[{to:"/maps",Icon:Rg,tag:"MAPS",accent:"#59B37A",titleKey:"home.features.toolkit.maps.title",captionKey:"home.features.toolkit.maps.caption",stats:[["home.features.toolkit.stats.regions",kl.length],["home.features.toolkit.stats.locations",kl.reduce((r,e)=>r+e.nodes.length,0)],["home.features.toolkit.stats.gens","I–V"]]},{to:"/nuzlocke",Icon:xg,tag:"NUZLOCKE",accent:"#E14D6B",titleKey:"home.features.toolkit.nuzlocke.title",captionKey:"home.features.toolkit.nuzlocke.caption",stats:[["home.features.toolkit.stats.regions",kl.length+mg.length],["home.features.toolkit.stats.gens","I–IX"],["home.features.toolkit.stats.mode","SOLO+CO-OP"]]},{to:"/team",Icon:vg,tag:"TEAM",accent:"#6E7FD7",titleKey:"home.features.toolkit.team.title",captionKey:"home.features.toolkit.team.caption",stats:[["home.features.toolkit.stats.species",1025],["home.features.toolkit.stats.gens","I–IX"],["home.features.toolkit.stats.export","SHOWDOWN"]]},{to:"/versus",Icon:Ag,tag:"VERSUS",accent:"#F5A623",titleKey:"home.features.toolkit.versus.title",captionKey:"home.features.toolkit.versus.caption",stats:[["home.features.toolkit.stats.mode","1v1"],["home.features.toolkit.stats.gens","I–IX"],["home.features.toolkit.stats.engine","SMOGON"]]}];function Hb({card:r,index:e}){const{t}=Vn(),[n,i]=Ke.useState(!1),[s,a]=Ke.useState({x:0,y:0}),o=_g(r.accent),{Icon:l}=r;return P.jsxs(it.article,{"code-path":"src/pages/home/ToolkitSection.tsx:88:5",initial:{opacity:0,y:24},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-15%"},transition:{duration:.4,ease:zb,delay:e*.06},whileHover:{y:-6,scale:1.01},onHoverStart:()=>i(!0),onHoverEnd:()=>{i(!1),a({x:0,y:0})},onPointerMove:c=>{const u=c.currentTarget.getBoundingClientRect();a({x:((c.clientX-u.left)/u.width-.5)*-12,y:((c.clientY-u.top)/u.height-.5)*-12})},className:"group relative h-72 overflow-hidden rounded-lg border border-hairline bg-surface1 p-5 transition-[border-color,box-shadow] duration-200",style:{borderColor:n?`rgba(${o},0.55)`:void 0,boxShadow:n?`0 8px 40px rgba(${o},0.22)`:void 0},children:[P.jsx("div",{"code-path":"src/pages/home/ToolkitSection.tsx:113:7",className:"pointer-events-none absolute -bottom-6 -right-6 transition-opacity duration-300",style:{transform:`translate(${s.x}px, ${s.y}px)`,transition:"transform 150ms ease-out",opacity:n?.16:.08},"aria-hidden":!0,children:P.jsx(l,{"code-path":"src/pages/home/ToolkitSection.tsx:122:9",size:190,strokeWidth:.75,style:{color:r.accent}})}),P.jsxs("div",{"code-path":"src/pages/home/ToolkitSection.tsx:125:7",className:"relative flex h-full flex-col",children:[P.jsxs("div",{"code-path":"src/pages/home/ToolkitSection.tsx:127:9",className:"flex items-center justify-between",children:[P.jsx("span",{"code-path":"src/pages/home/ToolkitSection.tsx:128:11",className:"pixel-label text-[9px] text-tx-muted",children:r.tag}),P.jsxs("span",{"code-path":"src/pages/home/ToolkitSection.tsx:129:11",className:"inline-flex items-center gap-1.5 rounded-pill border px-2 py-0.5 pixel-label text-[8px]",style:{borderColor:`rgba(${o},0.5)`,color:r.accent},children:[P.jsx("span",{"code-path":"src/pages/home/ToolkitSection.tsx:133:13",className:"h-2 w-2 rounded-full",style:{background:r.accent,boxShadow:`0 0 6px rgba(${o},0.9)`}}),"LIVE"]})]}),P.jsx("h3",{"code-path":"src/pages/home/ToolkitSection.tsx:139:9",className:"mt-3 font-display text-[30px] font-extrabold uppercase leading-none tracking-wide text-tx-primary",children:t(r.titleKey)}),P.jsx("p",{"code-path":"src/pages/home/ToolkitSection.tsx:142:9",className:"mt-2 max-w-[46ch] text-[12.5px] font-medium leading-relaxed text-tx-secondary",children:t(r.captionKey)}),P.jsx("div",{"code-path":"src/pages/home/ToolkitSection.tsx:146:9",className:"flex-1"}),P.jsx("div",{"code-path":"src/pages/home/ToolkitSection.tsx:149:9",className:"grid grid-cols-3 divide-x divide-hairline border-y border-hairline py-2",children:r.stats.map(([c,u])=>P.jsxs("div",{"code-path":"src/pages/home/ToolkitSection.tsx:151:13",className:"px-3 first:pl-0",children:[P.jsx("div",{"code-path":"src/pages/home/ToolkitSection.tsx:152:15",className:"pixel-label text-[8px] text-tx-muted",children:t(c)}),P.jsx("div",{"code-path":"src/pages/home/ToolkitSection.tsx:153:15",className:"font-display text-[18px] font-bold tabular-nums",style:{color:r.accent},children:u})]},c))}),P.jsx("div",{"code-path":"src/pages/home/ToolkitSection.tsx:161:9",className:"mt-3.5",children:P.jsxs(as,{"code-path":"src/pages/home/ToolkitSection.tsx:162:11",to:r.to,className:"inline-flex h-9 items-center gap-1.5 rounded-md border px-4 font-display text-[12px] font-bold uppercase tracking-wider text-tx-primary transition-all duration-200 hover:-translate-y-0.5",style:{borderColor:`rgba(${o},0.6)`,background:`linear-gradient(135deg, rgba(${o},0.25), rgba(${o},0.10))`},children:[t("home.features.open"),P.jsx(Wd,{"code-path":"src/pages/home/ToolkitSection.tsx:171:13",size:14,className:"transition-transform duration-200 group-hover:translate-x-0.5"})]})})]})]})}function Vb(){const{t:r}=Vn();return P.jsx("section",{"code-path":"src/pages/home/ToolkitSection.tsx:183:5",className:"relative bg-abyss pb-24",children:P.jsxs("div",{"code-path":"src/pages/home/ToolkitSection.tsx:184:7",className:"mx-auto max-w-content border-t border-hairline px-4 pt-16 md:px-8 md:pt-20",children:[P.jsxs("div",{"code-path":"src/pages/home/ToolkitSection.tsx:185:9",className:"mb-8 flex items-center gap-3",children:[P.jsx("span",{"code-path":"src/pages/home/ToolkitSection.tsx:186:11",className:"pixel-label text-[10px] text-gold",children:r("home.features.toolkitEyebrow")}),P.jsx("span",{"code-path":"src/pages/home/ToolkitSection.tsx:187:11",className:"h-px flex-1 bg-hairline"})]}),P.jsx("div",{"code-path":"src/pages/home/ToolkitSection.tsx:189:9",className:"grid gap-5 lg:grid-cols-2",children:Gb.map((e,t)=>P.jsx(Hb,{"code-path":"src/pages/home/ToolkitSection.tsx:191:13",card:e,index:t},e.tag))})]})})}const Lc=[.16,1,.3,1];function Wb(){const r=new Date;return Math.floor((r.getTime()-new Date(r.getFullYear(),0,0).getTime())/864e5)}function Xb(r){return(Wb()+r)*137%Hd+1}function Yb({burstKey:r}){const e=Ke.useMemo(()=>Array.from({length:8},(t,n)=>{const i=n/8*Math.PI*2+Math.random()*.5,s=60+Math.random()*60;return{x:Math.cos(i)*s,y:Math.sin(i)*s}}),[r]);return r===0?null:P.jsx("div",{"code-path":"src/pages/home/Spotlight.tsx:42:5",className:"pointer-events-none absolute inset-0 z-20","aria-hidden":!0,children:e.map((t,n)=>P.jsx(it.img,{"code-path":"src/pages/home/Spotlight.tsx:44:9",src:"/sparkle.svg",alt:"",className:"absolute left-1/2 top-1/2 h-4 w-4",initial:{x:0,y:0,scale:0,opacity:1},animate:{x:t.x,y:t.y,scale:[0,1,0],opacity:[1,1,0]},transition:{duration:.7,delay:n*.03,ease:"easeOut"}},n))},r)}function qb(){const{t:r}=Vn(),e=ps(),[t,n]=Ke.useState(0),i=Xb(t),[s,a]=Ke.useState(null),[o,l]=Ke.useState(null),[c,u]=Ke.useState(!1),[d,f]=Ke.useState(0),[h,g]=Ke.useState(i);h!==i&&(g(i),a(null),l(null),u(!1)),Ke.useEffect(()=>{let D=!0;return Promise.all([tg(i),ng(i)]).then(([O,G])=>{D&&(a(O),l(G))}).catch(()=>{}),()=>{D=!1}},[i]);const _=Ke.useRef(null),p=Fc(0),m=Fc(0),b=Kf(p,{stiffness:180,damping:22}),w=Kf(m,{stiffness:180,damping:22}),[S,E]=Ke.useState({x:50,y:50,o:0}),T=D=>{const O=_.current?.getBoundingClientRect();if(!O)return;const G=(D.clientX-O.left)/O.width,U=(D.clientY-O.top)/O.height;m.set((G-.5)*8),p.set(-(U-.5)*8),E({x:G*100,y:U*100,o:1})},A=()=>{p.set(0),m.set(0),E(D=>({...D,o:0}))},v=(s?.types??[]).sort((D,O)=>D.slot-O.slot).map(D=>D.type.name),y=v[0]??"normal",C=v[1]??y,L=o?.is_legendary||o?.is_mythical;return P.jsx("section",{"code-path":"src/pages/home/Spotlight.tsx:122:5",className:"mx-auto max-w-content px-4 py-24 md:px-8",children:P.jsxs(it.div,{"code-path":"src/pages/home/Spotlight.tsx:123:7",initial:{clipPath:"inset(12% 8% 12% 8% round 24px)",opacity:.4},whileInView:{clipPath:"inset(0% 0% 0% 0% round 24px)",opacity:1},viewport:{once:!0,margin:"-25% 0px"},transition:{duration:.9,ease:Lc},className:Oi("relative overflow-hidden rounded-xl border border-hairline bg-surface1",L&&"legendary-ring"),children:[P.jsx("div",{"code-path":"src/pages/home/Spotlight.tsx:134:9","aria-hidden":!0,className:"absolute inset-0 transition-[background] duration-700",style:{background:`radial-gradient(640px 420px at 18% 30%, rgba(${Lt[y].rgb},0.18), transparent 70%), radial-gradient(560px 400px at 85% 75%, rgba(${Lt[C].rgb},0.14), transparent 70%)`}}),P.jsx("div",{"code-path":"src/pages/home/Spotlight.tsx:141:9",className:"grain-overlay absolute inset-0"}),P.jsxs("div",{"code-path":"src/pages/home/Spotlight.tsx:143:9",className:"relative grid gap-10 p-6 md:p-10 lg:grid-cols-12 lg:gap-6",children:[P.jsx("div",{"code-path":"src/pages/home/Spotlight.tsx:145:11",className:"lg:col-span-5",children:P.jsxs(it.div,{"code-path":"src/pages/home/Spotlight.tsx:146:13",ref:_,onPointerMove:T,onPointerLeave:A,className:"relative mx-auto aspect-square w-full max-w-[400px]",initial:{x:-40,opacity:0,filter:"blur(12px)"},whileInView:{x:0,opacity:1,filter:"blur(0px)"},viewport:{once:!0,margin:"-25% 0px"},transition:{duration:.7,ease:Lc},style:{perspective:800},children:[P.jsx("div",{"code-path":"src/pages/home/Spotlight.tsx:157:15",className:"type-aura animate-breathe",style:{background:`radial-gradient(circle at 50% 55%, rgba(${Lt[y].rgb},0.38) 0%, rgba(${Lt[y].rgb},0.12) 42%, transparent 70%)`}}),P.jsx("div",{"code-path":"src/pages/home/Spotlight.tsx:163:15",className:"absolute bottom-[8%] left-1/2 h-6 w-[58%] -translate-x-1/2 animate-breathe rounded-[50%] border border-gold/40"}),P.jsx(rr,{"code-path":"src/pages/home/Spotlight.tsx:164:15",mode:"sync",children:P.jsxs(it.div,{"code-path":"src/pages/home/Spotlight.tsx:165:17",className:"absolute inset-0",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},style:{rotateX:b,rotateY:w},children:[s&&P.jsx("img",{"code-path":"src/pages/home/Spotlight.tsx:175:21",src:c?Sr.artworkShiny(i):Sr.artwork(i),alt:`${r("home.hero.artworkAlt",{name:os(i,e)})}${c?r("detail.hero.shinySuffix"):""}`,draggable:!1,className:"h-full w-full object-contain drop-shadow-[0_24px_48px_rgba(0,0,0,0.5)]"}),!s&&P.jsx("div",{"code-path":"src/pages/home/Spotlight.tsx:183:21",className:"grid h-full w-full place-items-center",children:P.jsx(Vd,{"code-path":"src/pages/home/Spotlight.tsx:184:23",variant:"inline"})})]},i+String(c))}),P.jsx("div",{"code-path":"src/pages/home/Spotlight.tsx:190:15","aria-hidden":!0,className:"pointer-events-none absolute inset-0 transition-opacity duration-300",style:{opacity:S.o,background:`radial-gradient(240px 240px at ${S.x}% ${S.y}%, rgba(255,255,255,0.10), transparent 70%)`}}),P.jsx(Yb,{"code-path":"src/pages/home/Spotlight.tsx:198:15",burstKey:d}),P.jsx("button",{"code-path":"src/pages/home/Spotlight.tsx:200:15",type:"button","aria-pressed":c,"aria-label":r("detail.hero.shinyArtwork"),onClick:()=>{u(D=>!D),f(D=>D+1)},className:Oi("absolute right-0 top-0 z-10 grid h-10 w-10 place-items-center rounded-md border transition-all duration-200",c?"border-gold/60 bg-gold-soft text-gold shadow-glow-gold":"border-hairline bg-surface2/80 text-tx-muted hover:border-hairline2 hover:text-gold"),children:P.jsx(Sg,{"code-path":"src/pages/home/Spotlight.tsx:215:17",size:18,strokeWidth:1.75})})]})}),P.jsx("div",{"code-path":"src/pages/home/Spotlight.tsx:221:11",className:"flex flex-col justify-center gap-4 lg:col-span-7",children:P.jsx(rr,{"code-path":"src/pages/home/Spotlight.tsx:222:13",mode:"wait",children:P.jsx(it.div,{"code-path":"src/pages/home/Spotlight.tsx:223:15",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.4},className:"flex flex-col gap-4",children:[P.jsx("span",{"code-path":"src/pages/home/Spotlight.tsx:232:19",className:"pixel-label text-[11px] text-gold",children:ig(i)},"num"),P.jsxs("div",{"code-path":"src/pages/home/Spotlight.tsx:235:19",children:[P.jsx("h2",{"code-path":"src/pages/home/Spotlight.tsx:236:21",className:"font-display text-[clamp(24px,3vw,36px)] font-extrabold uppercase leading-[1.15]",children:s?os(i,e):"…"}),P.jsx("p",{"code-path":"src/pages/home/Spotlight.tsx:239:21",className:"mt-1 font-sans text-base italic text-tx-secondary",children:e==="de"?rg(i,e):o?sg(o):" "})]},"name"),P.jsx("div",{"code-path":"src/pages/home/Spotlight.tsx:243:19",className:"flex flex-wrap gap-2",children:v.map(D=>P.jsx(ag,{"code-path":"src/pages/home/Spotlight.tsx:245:23",type:D,glow:!0},D))},"types"),P.jsx("p",{"code-path":"src/pages/home/Spotlight.tsx:248:19",className:"max-w-[62ch] font-sans text-base leading-[1.55] text-tx-secondary",children:o?og(o,e):r("home.spotlight.loadingFlavor")},"flavor"),P.jsxs("div",{"code-path":"src/pages/home/Spotlight.tsx:251:19",className:"flex max-w-[440px] flex-col gap-2.5",children:[P.jsx($o,{"code-path":"src/pages/home/Spotlight.tsx:252:21",label:"HP",value:s?Bl(s,"hp"):0,type:y}),P.jsx($o,{"code-path":"src/pages/home/Spotlight.tsx:253:21",label:"ATK",value:s?Bl(s,"attack"):0,type:y,delay:80}),P.jsx($o,{"code-path":"src/pages/home/Spotlight.tsx:254:21",label:"DEF",value:s?Bl(s,"defense"):0,type:y,delay:160})]},"stats"),P.jsxs("div",{"code-path":"src/pages/home/Spotlight.tsx:256:19",className:"mt-2 flex flex-wrap gap-4",children:[P.jsxs(as,{"code-path":"src/pages/home/Spotlight.tsx:257:21",to:`/pokemon/${i}`,className:"group relative inline-flex items-center gap-2 overflow-hidden rounded-md border px-6 py-3 font-display text-sm font-bold uppercase tracking-[0.06em] text-tx-primary transition-all duration-200 hover:-translate-y-0.5 active:scale-[0.97]",style:{borderColor:`rgba(${Lt[y].rgb},0.6)`,background:`linear-gradient(135deg, rgba(${Lt[y].rgb},0.25), rgba(${Lt[y].rgb},0.10))`,boxShadow:`0 0 0 rgba(${Lt[y].rgb},0)`},children:[P.jsx("span",{"code-path":"src/pages/home/Spotlight.tsx:266:23",className:"absolute inset-0 -translate-x-full bg-[linear-gradient(110deg,transparent_30%,rgba(255,255,255,0.35)_50%,transparent_70%)] transition-transform duration-sheen group-hover:translate-x-full"}),P.jsx("span",{"code-path":"src/pages/home/Spotlight.tsx:267:23",className:"relative",children:r("home.spotlight.viewEntry")})]}),P.jsx("button",{"code-path":"src/pages/home/Spotlight.tsx:269:21",type:"button",onClick:()=>n(D=>D+1),className:"rounded-md border border-hairline2 px-6 py-3 font-display text-sm font-bold uppercase tracking-[0.06em] text-tx-secondary transition-all duration-200 hover:-translate-y-0.5 hover:bg-surface3 hover:text-gold active:scale-[0.97]",children:r("home.spotlight.next")})]},"cta")].map((D,O)=>P.jsx(it.div,{"code-path":"src/pages/home/Spotlight.tsx:278:19",initial:{y:24,opacity:0},whileInView:{y:0,opacity:1},viewport:{once:!0,margin:"-20% 0px"},transition:{duration:.5,delay:O*.08,ease:Lc},children:D},D.key))},i)})})]})]})})}const $b=[.16,1,.3,1],Ic=()=>typeof window<"u"&&window.matchMedia("(pointer: coarse)").matches;function Kb(){const r=kd(),e=zd(),{t}=Vn(),n=ps(),[i,s]=Ke.useState(null),a=o=>{if(Ic()&&i!==o){s(o);return}r(e(`/pokedex?type=${o}`))};return P.jsxs("section",{"code-path":"src/pages/home/TypeSpectrum.tsx:35:5",className:"mx-auto max-w-content overflow-x-clip px-4 py-24 md:px-8",children:[P.jsxs(Gf,{"code-path":"src/pages/home/TypeSpectrum.tsx:36:7",className:"mb-12 flex flex-col items-center gap-4 text-center",children:[P.jsx("span",{"code-path":"src/pages/home/TypeSpectrum.tsx:37:9",className:"pixel-label text-[10px] text-gold",children:t("home.spectrum.eyebrow")}),P.jsx("h2",{"code-path":"src/pages/home/TypeSpectrum.tsx:38:9",className:"font-display text-[clamp(24px,3vw,36px)] font-extrabold uppercase leading-[1.15]",children:t("home.spectrum.title")}),P.jsx("p",{"code-path":"src/pages/home/TypeSpectrum.tsx:41:9",className:"max-w-[52ch] font-sans text-base text-tx-secondary",children:t("home.spectrum.blurb")})]}),P.jsx("div",{"code-path":"src/pages/home/TypeSpectrum.tsx:47:7",className:"flex w-full min-w-0 snap-x snap-mandatory gap-3 overflow-x-auto overscroll-x-contain pb-4 sm:grid sm:grid-cols-6 sm:overflow-visible sm:pb-0",children:lg.map((o,l)=>{const c=Math.floor(l/6),u=l%6,d=Math.abs(c-1)+Math.abs(u-2.5),f=i===o,h=Lt[o].rgb;return P.jsxs(it.button,{"code-path":"src/pages/home/TypeSpectrum.tsx:55:13",type:"button","data-type":o,onClick:()=>a(o),onMouseEnter:()=>!Ic()&&s(o),onMouseLeave:()=>!Ic()&&s(null),className:Oi("group relative flex h-24 w-24 shrink-0 snap-center flex-col items-center justify-center gap-2 rounded-md border sm:h-24 sm:w-auto","transition-colors duration-300 focus-visible:border-[rgba(var(--t),0.8)]",f?"border-[rgba(var(--t),0.6)]":"border-hairline bg-surface1"),style:{"--t":h,background:f?`radial-gradient(circle at 50% 60%, rgba(${h},0.22), transparent 75%)`:void 0,backgroundColor:void 0},initial:{scale:.6,opacity:0},whileInView:{scale:1,opacity:1},viewport:{once:!0,margin:"-20% 0px"},transition:{duration:.5,delay:d*.035,ease:$b},children:[P.jsx(rr,{"code-path":"src/pages/home/TypeSpectrum.tsx:80:15",children:f&&P.jsx("div",{"code-path":"src/pages/home/TypeSpectrum.tsx:82:19",className:"pointer-events-none absolute -top-14 left-1/2 z-20 hidden -translate-x-1/2 gap-1 sm:flex",children:cg[o].map((g,_)=>P.jsx(it.div,{"code-path":"src/pages/home/TypeSpectrum.tsx:84:23",initial:{scale:0,y:8},animate:{scale:1,y:[8,-4,0]},exit:{scale:0,opacity:0},transition:{type:"spring",stiffness:420,damping:30,delay:_*.06},children:P.jsx(no,{"code-path":"src/pages/home/TypeSpectrum.tsx:91:25",id:g,name:ef(o,n),era:"gen5",skeleton:!1,className:"h-12 w-12"})},g))})}),P.jsx(it.span,{"code-path":"src/pages/home/TypeSpectrum.tsx:98:15",animate:f?{scale:[1,1.18,.96,1],rotate:[0,-4,3,0]}:{scale:1,rotate:0},transition:{duration:.3},className:Oi("transition-all duration-300",f?"text-[rgb(var(--t))] opacity-100 drop-shadow-[0_0_12px_rgba(var(--t),0.8)]":"text-tx-secondary opacity-35 grayscale"),style:{"--t":h},children:P.jsx(Rl,{"code-path":"src/pages/home/TypeSpectrum.tsx:109:17",type:o,size:32})}),P.jsx("span",{"code-path":"src/pages/home/TypeSpectrum.tsx:111:15",className:Oi("pixel-label text-[9px] transition-colors duration-300",f?"text-[rgb(var(--t))]":"text-tx-muted"),style:{"--t":h},children:o})]},o)})})]})}const Fd=[.16,1,.3,1],Zb=[`rgb(${Lt.grass.rgb})`,`rgb(${Lt.fire.rgb})`,`rgb(${Lt.water.rgb})`,`rgb(${Lt.grass.rgb})`];function jb(){const{t:r}=Vn(),e=Ke.useRef(null),t=Ke.useRef(null),n=Fc(0),[i,s]=Ke.useState(0),a=Gd(n,l=>i>0?Math.min(1,Math.max(0,-l/i)):0);Ke.useEffect(()=>{const l=()=>{const u=t.current,d=e.current;!u||!d||s(Math.max(0,u.scrollWidth-d.clientWidth))};l();const c=new ResizeObserver(l);return e.current&&c.observe(e.current),()=>c.disconnect()},[]);const o=l=>{const c=Math.min(0,Math.max(-i,n.get()+l*-344));tf(n,c,{duration:.4,ease:Fd})};return P.jsxs("section",{"code-path":"src/pages/home/GenerationsRail.tsx:51:5",className:"overflow-x-clip py-24",children:[P.jsxs(Gf,{"code-path":"src/pages/home/GenerationsRail.tsx:52:7",className:"mx-auto mb-10 flex max-w-content flex-wrap items-end justify-between gap-6 px-4 md:px-8",children:[P.jsxs("div",{"code-path":"src/pages/home/GenerationsRail.tsx:53:9",className:"flex flex-col gap-4",children:[P.jsx("span",{"code-path":"src/pages/home/GenerationsRail.tsx:54:11",className:"pixel-label text-[10px] text-gold",children:"1996 → 2022"}),P.jsx("h2",{"code-path":"src/pages/home/GenerationsRail.tsx:55:11",className:"font-display text-[clamp(24px,3vw,36px)] font-extrabold uppercase leading-[1.15]",children:r("home.generations.title")})]}),P.jsxs("div",{"code-path":"src/pages/home/GenerationsRail.tsx:59:9",className:"flex items-center gap-4",children:[P.jsx("span",{"code-path":"src/pages/home/GenerationsRail.tsx:60:11",className:"pixel-label hidden text-[9px] text-tx-muted sm:block",children:r("home.generations.drag")}),P.jsx("button",{"code-path":"src/pages/home/GenerationsRail.tsx:61:11",type:"button",onClick:()=>o(-1),"aria-label":r("home.generations.prev"),className:"grid h-10 w-10 place-items-center rounded-md border border-hairline bg-surface2 text-tx-secondary transition-all duration-200 hover:border-gold/60 hover:text-gold",children:P.jsx(Mg,{"code-path":"src/pages/home/GenerationsRail.tsx:67:13",size:18,strokeWidth:1.75})}),P.jsx("button",{"code-path":"src/pages/home/GenerationsRail.tsx:69:11",type:"button",onClick:()=>o(1),"aria-label":r("home.generations.next"),className:"grid h-10 w-10 place-items-center rounded-md border border-hairline bg-surface2 text-tx-secondary transition-all duration-200 hover:border-gold/60 hover:text-gold",children:P.jsx(Wd,{"code-path":"src/pages/home/GenerationsRail.tsx:75:13",size:18,strokeWidth:1.75})})]})]}),P.jsxs(it.div,{"code-path":"src/pages/home/GenerationsRail.tsx:80:7",initial:{x:60,opacity:0},whileInView:{x:0,opacity:1},viewport:{once:!0,margin:"-20% 0px"},transition:{duration:.7,ease:Fd},className:"overflow-x-clip",children:[P.jsx("div",{"code-path":"src/pages/home/GenerationsRail.tsx:87:9",ref:e,className:"overflow-hidden",children:P.jsx(it.div,{"code-path":"src/pages/home/GenerationsRail.tsx:88:11",ref:t,drag:"x",style:{x:n},dragConstraints:{left:-i,right:0},dragTransition:{power:.4,timeConstant:220},className:"flex cursor-grab gap-6 px-4 active:cursor-grabbing md:px-8",children:ug.map(l=>{const c=l.range[1]-l.range[0]+1,u=l.gen<=5?"gen5":"home";return P.jsxs(as,{"code-path":"src/pages/home/GenerationsRail.tsx:100:17",to:`/pokedex?gen=${l.gen}`,draggable:!1,onDragStart:d=>d.preventDefault(),className:"group relative flex h-[360px] w-[260px] shrink-0 flex-col justify-between overflow-hidden rounded-lg border border-hairline bg-surface1 p-6 transition-transform duration-300 ease-out-expo hover:-translate-y-1.5 sm:w-[320px]",children:[P.jsx(it.div,{"code-path":"src/pages/home/GenerationsRail.tsx:108:19","aria-hidden":!0,className:"pointer-events-none absolute inset-0 rounded-lg border opacity-0 transition-opacity duration-300 group-hover:opacity-100",animate:{borderColor:Zb},transition:{duration:3,repeat:1/0,ease:"linear"}}),P.jsx("span",{"code-path":"src/pages/home/GenerationsRail.tsx:115:19","aria-hidden":!0,className:"absolute -right-2 -top-4 select-none font-display text-8xl font-black text-tx-primary/[0.08]",children:l.roman}),P.jsxs("div",{"code-path":"src/pages/home/GenerationsRail.tsx:122:19",className:"flex items-baseline justify-between",children:[P.jsxs("span",{"code-path":"src/pages/home/GenerationsRail.tsx:123:21",className:"pixel-label text-[10px] text-gold",children:["GEN ",l.roman]}),P.jsx("span",{"code-path":"src/pages/home/GenerationsRail.tsx:124:21",className:"font-sans text-xs font-medium text-tx-muted",children:l.year})]}),P.jsx("div",{"code-path":"src/pages/home/GenerationsRail.tsx:127:19",className:"flex items-end justify-center gap-2",children:l.starters.map((d,f)=>P.jsx("div",{"code-path":"src/pages/home/GenerationsRail.tsx:129:23",className:"group-hover:animate-[hop_0.42s_ease-in-out]",style:{animationDelay:`${f*100}ms`},children:P.jsx(no,{"code-path":"src/pages/home/GenerationsRail.tsx:134:25",id:d,name:r("home.generations.starterAlt",{roman:l.roman}),era:u,skeleton:!1,className:"h-20 w-20 sm:h-24 sm:w-24"})},d))}),P.jsxs("div",{"code-path":"src/pages/home/GenerationsRail.tsx:139:19",children:[P.jsx("h3",{"code-path":"src/pages/home/GenerationsRail.tsx:140:21",className:"font-sans text-lg font-bold text-tx-primary transition-colors duration-200 group-hover:text-gold",children:r(`regions.${fg(l.region)}`)}),P.jsx("span",{"code-path":"src/pages/home/GenerationsRail.tsx:143:21",className:"pixel-label mt-1 block text-[9px] text-tx-muted",children:r("home.generations.count",{count:c})})]})]},l.gen)})})}),P.jsx("div",{"code-path":"src/pages/home/GenerationsRail.tsx:154:9",className:"mx-4 mt-6 h-0.5 overflow-hidden rounded-pill bg-surface3 md:mx-8",children:P.jsx(it.div,{"code-path":"src/pages/home/GenerationsRail.tsx:155:11",className:"h-full origin-left bg-gradient-to-r from-gold to-type-fire",style:{scaleX:a}})})]})]})}const Hf=[.16,1,.3,1],Jb=[{id:1,name:"Bulbasaur",types:["grass","poison"]},{id:2,name:"Ivysaur",types:["grass","poison"]},{id:3,name:"Venusaur",types:["grass","poison"]},{id:4,name:"Charmander",types:["fire"]},{id:5,name:"Charmeleon",types:["fire"]},{id:6,name:"Charizard",types:["fire","flying"]}],Qb=["grass","fire","water"];function e1({live:r}){const{t:e}=Vn(),t=ps(),[n,i]=Ke.useState(null),s=Jb.filter(a=>!n||a.types.includes(n));return P.jsxs("div",{"code-path":"src/pages/home/Features.tsx:37:5",className:"flex flex-col gap-3",children:[P.jsx("div",{"code-path":"src/pages/home/Features.tsx:38:7",className:"flex gap-2",children:Qb.map(a=>{const o=n===a;return P.jsxs("button",{"code-path":"src/pages/home/Features.tsx:42:13",type:"button","aria-pressed":o,onClick:()=>i(o?null:a),className:Oi("inline-flex items-center gap-1.5 rounded-pill border px-2.5 py-1 font-sans text-xs font-semibold capitalize transition-all duration-200",o?"-translate-y-0.5 border-[rgba(var(--t),0.8)] bg-[rgba(var(--t),0.18)] text-[rgb(var(--t))] shadow-[0_0_12px_rgba(var(--t),0.35)]":"border-hairline bg-surface2 text-tx-muted hover:text-tx-secondary"),style:{"--t":Lt[a].rgb},children:[P.jsx(Rl,{"code-path":"src/pages/home/Features.tsx:55:15",type:a,size:14}),ef(a,t)]},a)})}),P.jsxs(it.div,{"code-path":"src/pages/home/Features.tsx:61:7",layout:!0,className:"grid min-h-[148px] grid-cols-3 content-start gap-2",children:[P.jsx(rr,{"code-path":"src/pages/home/Features.tsx:62:9",mode:"popLayout",children:s.map(a=>P.jsxs(it.div,{"code-path":"src/pages/home/Features.tsx:64:13",layout:!0,initial:{scale:.9,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.9,opacity:0},transition:{duration:.25,ease:Hf},className:"relative flex flex-col items-center gap-1 rounded-md border border-hairline bg-surface2 p-2",children:[P.jsx("div",{"code-path":"src/pages/home/Features.tsx:73:15","aria-hidden":!0,className:"absolute inset-x-2 top-1 h-8 rounded-full blur-md",style:{background:`rgba(${Lt[a.types[0]].rgb},0.25)`}}),P.jsx(no,{"code-path":"src/pages/home/Features.tsx:78:15",id:a.id,name:os(a.id,t),era:"gen5",skeleton:!1,eager:r,className:"relative h-14 w-14"}),P.jsx("span",{"code-path":"src/pages/home/Features.tsx:79:15",className:"font-sans text-[11px] font-semibold text-tx-secondary",children:os(a.id,t)})]},a.id))}),s.length===0&&P.jsxs(it.div,{"code-path":"src/pages/home/Features.tsx:84:11",initial:{opacity:0},animate:{opacity:1},className:"col-span-3 flex flex-col items-center gap-2 py-6",children:[P.jsx("img",{"code-path":"src/pages/home/Features.tsx:89:13",src:"/empty-dex.svg",alt:"",className:"h-14 w-auto opacity-70"}),P.jsx("span",{"code-path":"src/pages/home/Features.tsx:90:13",className:"font-sans text-xs font-medium text-gold",children:e("home.features.emptyDemo")})]})]})]})}const Od={hp:35,attack:55,defense:40,"special-attack":50,"special-defense":50,speed:90};function t1({values:r,prog:e}){const t=Ke.useRef(null),n=62,i=80;Ke.useEffect(()=>{const a=r.map((o,l)=>{const c=(-90+l*60)*(Math.PI/180),u=o/180*n*e;return`${i+Math.cos(c)*u},${i+Math.sin(c)*u}`}).join(" ");t.current?.setAttribute("points",a)},[r,e]);const s=[.33,.66,1];return P.jsxs("svg",{"code-path":"src/pages/home/Features.tsx:125:5",viewBox:"0 0 160 160",className:"h-[160px] w-[160px]",children:[s.map(a=>P.jsx("polygon",{"code-path":"src/pages/home/Features.tsx:127:9",points:Array.from({length:6},(o,l)=>{const c=(-90+l*60)*(Math.PI/180);return`${i+Math.cos(c)*n*a},${i+Math.sin(c)*n*a}`}).join(" "),fill:"none",stroke:"rgba(255,255,255,0.08)",strokeWidth:"1"},a)),Array.from({length:6},(a,o)=>{const l=(-90+o*60)*(Math.PI/180);return P.jsx("line",{"code-path":"src/pages/home/Features.tsx:141:11",x1:i,y1:i,x2:i+Math.cos(l)*n,y2:i+Math.sin(l)*n,stroke:"rgba(255,255,255,0.08)",strokeWidth:"1"},o)}),P.jsx("polygon",{"code-path":"src/pages/home/Features.tsx:152:7",ref:t,fill:"rgba(255,214,10,0.25)",stroke:"#FFD60A",strokeWidth:"1.5"})]})}function n1({live:r}){const{t:e}=Vn(),[t,n]=Ke.useState("bars"),[i,s]=Ke.useState(0),[a,o]=Ke.useState(0);Ke.useEffect(()=>{if(!r||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const c=window.setInterval(()=>s(u=>u+1),4e3);return()=>window.clearInterval(c)},[r]),Ke.useEffect(()=>{if(t!=="radar")return;const c=tf(0,1,{duration:.6,ease:Hf,onUpdate:o});return()=>c.stop()},[t,i]);const l=Zf.map(c=>Od[c]);return P.jsxs("div",{"code-path":"src/pages/home/Features.tsx:181:5",className:"flex flex-col gap-3",children:[P.jsx("div",{"code-path":"src/pages/home/Features.tsx:182:7",className:"relative flex w-fit rounded-pill border border-hairline bg-surface1 p-1",children:["bars","radar"].map(c=>P.jsxs("button",{"code-path":"src/pages/home/Features.tsx:184:11",type:"button","aria-pressed":t===c,onClick:()=>n(c),className:Oi("relative rounded-pill px-3 py-1 font-sans text-[13px] font-semibold capitalize transition-colors",t===c?"text-gold":"text-tx-muted hover:text-tx-secondary"),children:[t===c&&P.jsx(it.span,{"code-path":"src/pages/home/Features.tsx:195:15",layoutId:"stats-thumb",className:"absolute inset-0 rounded-pill border border-gold/50 bg-surface3",transition:{type:"spring",stiffness:420,damping:30}}),P.jsx("span",{"code-path":"src/pages/home/Features.tsx:201:13",className:"relative",children:e(`detail.combat.${c}`)})]},c))}),P.jsx("div",{"code-path":"src/pages/home/Features.tsx:205:7",className:"grid min-h-[148px] place-items-center",children:P.jsx(rr,{"code-path":"src/pages/home/Features.tsx:206:9",mode:"wait",children:t==="bars"?P.jsx(it.div,{"code-path":"src/pages/home/Features.tsx:208:13",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},className:"flex w-full flex-col gap-2",children:Zf.map((c,u)=>P.jsx($o,{"code-path":"src/pages/home/Features.tsx:217:17",label:hg[c],value:Od[c],type:"electric",delay:u*60},c))},`bars-${i}`):P.jsx(it.div,{"code-path":"src/pages/home/Features.tsx:221:13",initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0},transition:{duration:.3},children:P.jsx(t1,{"code-path":"src/pages/home/Features.tsx:228:15",values:l,prog:a})},`radar-${i}`)})})]})}const Uc=[{year:1996,label:"GEN I",era:"gen1",rgb:Lt.normal.rgb},{year:1999,label:"GEN II",era:"gen2",rgb:Lt.electric.rgb},{year:2004,label:"GEN IV",era:"gen4",rgb:Lt.grass.rgb},{year:2010,label:"GEN V",era:"gen5",rgb:Lt.water.rgb},{year:2016,label:"3D ERA",era:"showdown",rgb:Lt.fire.rgb}];function i1(){const{t:r}=Vn(),[e,t]=Ke.useState(0),n=Uc[e],i=n.era==="gen1"?Sr.gen1RedBlue(25):n.era==="gen2"?Sr.gen2Crystal(25):n.era==="gen4"?Sr.gen4Platinum(25):n.era==="gen5"?Sr.gen5Animated(25):Sr.showdown(25);return P.jsxs("div",{"code-path":"src/pages/home/Features.tsx:263:5",className:"flex flex-col gap-3",children:[P.jsxs("div",{"code-path":"src/pages/home/Features.tsx:264:7",className:"relative mx-auto grid h-[148px] w-[148px] place-items-center",children:[P.jsx("div",{"code-path":"src/pages/home/Features.tsx:266:9","aria-hidden":!0,className:"absolute bottom-4 h-5 w-24 rounded-[50%] blur-[6px] transition-colors duration-500",style:{background:`rgba(${n.rgb},0.35)`,boxShadow:`0 0 24px rgba(${n.rgb},0.4)`}}),P.jsx(rr,{"code-path":"src/pages/home/Features.tsx:271:9",mode:"sync",children:P.jsx(it.img,{"code-path":"src/pages/home/Features.tsx:272:11",src:i,alt:`Pikachu — ${n.label} sprite`,draggable:!1,className:Oi("relative h-24 w-24 object-contain",n.era!=="showdown"&&"pixelated"),initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.25}},n.year)})]}),P.jsx("input",{"code-path":"src/pages/home/Features.tsx:285:7",type:"range",min:0,max:Uc.length-1,step:1,value:e,onChange:s=>t(Number(s.target.value)),"aria-label":r("home.features.scrubberAria"),className:"w-full accent-gold"}),P.jsx("div",{"code-path":"src/pages/home/Features.tsx:295:7",className:"flex justify-between",children:Uc.map((s,a)=>P.jsx("button",{"code-path":"src/pages/home/Features.tsx:297:11",type:"button",onClick:()=>t(a),className:Oi("pixel-label text-[8px] transition-colors",a===e?"text-gold":"text-tx-muted hover:text-tx-secondary"),children:s.year},s.year))})]})}const r1=[{titleKey:"home.features.filterTitle",captionKey:"home.features.filterCaption",Demo:e1},{titleKey:"home.features.statsTitle",captionKey:"home.features.statsCaption",Demo:n1},{titleKey:"home.features.museumTitle",captionKey:"home.features.museumCaption",Demo:i1}],s1=[{labelKey:"home.features.roadmap.p2",to:"/pokemon/6?vs=3"},{labelKey:"home.features.roadmap.p3",to:"/team"},{labelKey:"home.features.roadmap.p4",to:"/maps"},{labelKey:"home.features.roadmap.p5",to:"/nuzlocke"},{labelKey:"home.features.roadmap.p6"},{labelKey:"home.features.roadmap.p7"}];function a1({titleKey:r,captionKey:e,Demo:t,index:n}){const{t:i}=Vn(),s=Ke.useRef(null),a=Xd(s,{once:!0,margin:"-20% 0px"});return P.jsxs(it.div,{"code-path":"src/pages/home/Features.tsx:337:5",ref:s,initial:{y:40,opacity:0,filter:"blur(8px)"},whileInView:{y:0,opacity:1,filter:"blur(0px)"},viewport:{once:!0,margin:"-20% 0px"},transition:{duration:.6,delay:n*.12,ease:Hf},className:"flex flex-col gap-4 rounded-xl border border-hairline bg-surface1 p-6 lg:aspect-[5/6]",children:[P.jsx(t,{"code-path":"src/pages/home/Features.tsx:345:7",live:a}),P.jsxs("div",{"code-path":"src/pages/home/Features.tsx:346:7",className:"mt-auto",children:[P.jsx("h3",{"code-path":"src/pages/home/Features.tsx:347:9",className:"font-display text-lg font-bold",children:i(r)}),P.jsx("p",{"code-path":"src/pages/home/Features.tsx:348:9",className:"mt-1 font-sans text-sm text-tx-secondary",children:i(e)})]})]})}function o1(){const{t:r}=Vn();return P.jsxs("section",{"code-path":"src/pages/home/Features.tsx:357:5",className:"mx-auto max-w-content overflow-x-clip px-4 py-24 md:px-8",children:[P.jsxs("div",{"code-path":"src/pages/home/Features.tsx:358:7",className:"mb-12 flex flex-col gap-4",children:[P.jsx("span",{"code-path":"src/pages/home/Features.tsx:359:9",className:"pixel-label text-[10px] text-gold",children:r("home.features.eyebrow")}),P.jsx("h2",{"code-path":"src/pages/home/Features.tsx:360:9",className:"font-display text-[clamp(24px,3vw,36px)] font-extrabold uppercase leading-[1.15]",children:r("home.features.title")})]}),P.jsx("div",{"code-path":"src/pages/home/Features.tsx:365:7",className:"grid gap-6 md:grid-cols-3",children:r1.map((e,t)=>P.jsx(a1,{"code-path":"src/pages/home/Features.tsx:367:11",titleKey:e.titleKey,captionKey:e.captionKey,Demo:e.Demo,index:t},e.titleKey))}),P.jsx("div",{"code-path":"src/pages/home/Features.tsx:372:7",className:"group relative mt-10 overflow-hidden border-y border-hairline py-4 [mask-image:linear-gradient(90deg,transparent,black_10%,black_90%,transparent)]",children:P.jsx("div",{"code-path":"src/pages/home/Features.tsx:373:9",className:"flex w-max animate-[marquee_60s_linear_infinite] gap-10 group-hover:[animation-play-state:paused] sm:animate-[marquee_40s_linear_infinite]",children:[0,1].map(e=>P.jsx("div",{"code-path":"src/pages/home/Features.tsx:375:13",className:"flex gap-10","aria-hidden":e===1,children:s1.map(t=>t.to?P.jsxs(as,{"code-path":"src/pages/home/Features.tsx:378:19",to:t.to,tabIndex:e===1?-1:0,className:"flex items-center gap-2 opacity-70 transition-opacity hover:opacity-100",children:[P.jsx("span",{"code-path":"src/pages/home/Features.tsx:384:21",className:"h-1.5 w-1.5 rounded-full bg-gold shadow-glow-gold"}),P.jsx("span",{"code-path":"src/pages/home/Features.tsx:385:21",className:"pixel-label whitespace-nowrap text-[9px] text-tx-secondary",children:r(t.labelKey)}),P.jsx("span",{"code-path":"src/pages/home/Features.tsx:386:21",className:"pixel-label text-[8px] text-gold",children:r("home.features.live")})]},`${e}-${t.labelKey}`):P.jsxs("span",{"code-path":"src/pages/home/Features.tsx:389:19",className:"group/item relative flex cursor-default items-center gap-2 opacity-40",children:[P.jsx(yg,{"code-path":"src/pages/home/Features.tsx:390:21",size:12,strokeWidth:1.75,className:"text-tx-muted"}),P.jsx("span",{"code-path":"src/pages/home/Features.tsx:391:21",className:"pixel-label whitespace-nowrap text-[9px] text-tx-secondary",children:r(t.labelKey)}),P.jsx("span",{"code-path":"src/pages/home/Features.tsx:392:21",className:"pointer-events-none absolute -top-9 left-1/2 -translate-x-1/2 scale-95 whitespace-nowrap rounded-sm border border-hairline bg-surface2 px-2 py-1 font-sans text-xs text-tx-secondary opacity-0 shadow-elevate transition-all duration-150 group-hover/item:scale-100 group-hover/item:opacity-100",children:r("home.features.lockedTip")})]},`${e}-${t.labelKey}`))},e))})})]})}const l1=[{target:1025,labelKey:"home.statsband.pokemon"},{target:18,labelKey:"home.statsband.types"},{target:9,labelKey:"home.statsband.generations"},{target:1e4,labelKey:"home.statsband.sprites",suffix:"+"}];function c1({target:r,format:e,delay:t}){const n=Ke.useRef(null),i=Xd(n,{once:!0,margin:"-20% 0px"}),[s,a]=Ke.useState(e(0));return Ke.useEffect(()=>{if(!i)return;const o=window.matchMedia("(prefers-reduced-motion: reduce)").matches,l=tf(0,r,{duration:o?0:1.2,delay:t,ease:[.16,1,.3,1],onUpdate:c=>a(e(Math.round(c)))});return()=>l.stop()},[i,r,t,e]),P.jsx("span",{"code-path":"src/pages/home/StatsBand.tsx:32:5",ref:n,className:"font-display text-[40px] font-extrabold leading-none text-gold tabular-nums",children:s})}function u1(){const{t:r}=Vn(),e=ps(),t=(n,i="")=>`${n.toLocaleString(e==="de"?"de-DE":"en-US")}${i}`;return P.jsxs("section",{"code-path":"src/pages/home/StatsBand.tsx:44:5",className:"relative overflow-x-clip border-y border-hairline bg-surface1",children:[P.jsx("div",{"code-path":"src/pages/home/StatsBand.tsx:46:7","aria-hidden":!0,className:"absolute left-[-10%] top-1/2 h-[240px] w-[420px] -translate-y-1/2 rounded-full blur-[80px]",style:{background:"radial-gradient(circle, rgba(69,200,255,0.10), transparent 70%)"}}),P.jsx("div",{"code-path":"src/pages/home/StatsBand.tsx:51:7","aria-hidden":!0,className:"absolute right-[-10%] top-1/2 h-[240px] w-[420px] -translate-y-1/2 rounded-full blur-[80px]",style:{background:"radial-gradient(circle, rgba(255,122,69,0.10), transparent 70%)"}}),P.jsx("div",{"code-path":"src/pages/home/StatsBand.tsx:56:7",className:"relative mx-auto grid max-w-content grid-cols-2 gap-10 px-4 py-16 md:px-8 lg:grid-cols-4",children:l1.map((n,i)=>P.jsxs("div",{"code-path":"src/pages/home/StatsBand.tsx:58:11",className:"flex flex-col items-center gap-3 text-center",children:[P.jsx(c1,{"code-path":"src/pages/home/StatsBand.tsx:59:13",target:n.target,format:s=>t(s,n.suffix),delay:i*.15}),P.jsx("span",{"code-path":"src/pages/home/StatsBand.tsx:60:13",className:"pixel-label text-[10px] text-tx-muted",children:r(n.labelKey)})]},n.labelKey))})]})}const Bd="pdx:preloader-done";function b1(){const[r,e]=Ke.useState(()=>{try{return!sessionStorage.getItem(Bd)}catch{return!1}}),t=()=>{try{sessionStorage.setItem(Bd,"1")}catch{}e(!1)};return P.jsxs(P.Fragment,{children:[P.jsx(rr,{"code-path":"src/pages/Home.tsx:37:7",children:r&&P.jsx(it.div,{"code-path":"src/pages/Home.tsx:39:11",exit:{opacity:0},transition:{duration:.5,ease:"easeOut"},className:"fixed inset-0 z-[100]",children:P.jsx(Vd,{"code-path":"src/pages/Home.tsx:45:13",variant:"page",onDone:t})},"preloader")}),P.jsx(Ob,{"code-path":"src/pages/Home.tsx:50:7",started:!r}),P.jsx(kb,{"code-path":"src/pages/Home.tsx:51:7"}),P.jsx(Vb,{"code-path":"src/pages/Home.tsx:52:7"}),P.jsx(qb,{"code-path":"src/pages/Home.tsx:53:7"}),P.jsx(Kb,{"code-path":"src/pages/Home.tsx:54:7"}),P.jsx(jb,{"code-path":"src/pages/Home.tsx:55:7"}),P.jsx(o1,{"code-path":"src/pages/Home.tsx:56:7"}),P.jsx(u1,{"code-path":"src/pages/Home.tsx:57:7"})]})}export{b1 as default};
