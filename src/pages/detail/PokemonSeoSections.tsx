    ...
    <div className="flex flex-col gap-4">
      ...
      <section className="rounded-lg border border-hairline bg-surface1">
        ...
        <div className="flex items-center gap-2 border-b border-hairline px-4 py-2 sm:px-5">
          <span className="pixel-label flex-1 text-[8px] text-tx-muted">{t('seo.pikachu.colLocation')}</span>
          <span className="pixel-label hidden w-[4.5rem] text-[8px] text-tx-muted sm:block">{t('seo.pikachu.colMethod')}</span>
          <span className="pixel-label w-[3.625rem] text-right text-[8px] text-tx-muted">{t('seo.pikachu.colLevel')}</span>
          <span className="pixel-label w-[5.25rem] text-right text-[8px] text-tx-muted">{t('seo.pikachu.colChance')}</span>
        </div>
        {PIKACHU_LOCATIONS.map((loc) => (
          ...
          >
            <span className="flex-1 truncate text-micro13 font-semibold text-tx-primary">
