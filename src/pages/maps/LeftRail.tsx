...
export default function LeftRail({ region, data, scanned, total, onPickNode }: LeftRailProps) {
  ...
  return (
    <aside className="nz-slim-scroll flex w-[232px] shrink-0 flex-col gap-4 overflow-y-auto border-r border-hairline bg-surface1/90 px-4 py-4 backdrop-blur-md">
      {/* coverage ring */}
