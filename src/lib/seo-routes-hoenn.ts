...
export const HOENN_ROUTE_SLUGS: Record<string, { de: string; en: string }> = {
  ...
  'hoenn-route-106': { de: 'route-106', en: 'route-106' },
  'hoenn-route-107': { de: 'route-107', en: 'route-107' },
  'hoenn-route-115': { de: 'route-115', en: 'route-115' },
  'hoenn-route-122': { de: 'route-122', en: 'route-122' },
  'hoenn-route-123': { de: 'route-123', en: 'route-123' },
  'hoenn-route-125': { de: 'route-125', en: 'route-125' },
  'hoenn-route-126': { de: 'route-126', en: 'route-126' },
  'hoenn-route-127': { de: 'route-127', en: 'route-127' },
  'hoenn-route-130': { de: 'route-130', en: 'route-130' },
  'hoenn-route-131': { de: 'route-131', en: 'route-131' },
  'hoenn-route-132': { de: 'route-132', en: 'route-132' },
  'hoenn-route-133': { de: 'route-133', en: 'route-133' },
  'hoenn-route-134': { de: 'route-134', en: 'route-134' },
